# tf-atom-cloudfront-distribution-aws

[![CI](https://github.com/PlatformStackPulse/tf-atom-cloudfront-distribution-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-cloudfront-distribution-aws/actions/workflows/ci.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)

## Purpose

Terraform atom: AWS CloudFront Distribution - creates a CDN distribution.
...
|------|-------------|------|---------|:--------:|
| <a name="input_default_cache_behavior"></a> [default\_cache\_behavior](#input\_default\_cache\_behavior) | Default cache behavior configuration | `any` | n/a | yes |
| <a name="input_origins"></a> [origins](#input\_origins) | List of origin configurations | `list(any)` | n/a | yes |
| <a name="input_acm_certificate_arn"></a> [acm\_certificate\_arn](#input\_acm\_certificate\_arn) | ARN of the ACM certificate for HTTPS | `string` | `null` | no |
| <a name="input_aliases"></a> [aliases](#input\_aliases) | CNAMEs for the distribution | `list(string)` | `[]` | no |
...
| <a name="input_distribution_enabled"></a> [distribution\_enabled](#input\_distribution\_enabled) | Whether the distribution is enabled | `bool` | `true` | no |
...
| <a name="input_web_acl_id"></a> [web\_acl\_id](#input\_web\_acl\_id) | WAF Web ACL ARN to associate | `string` | `null` | no |
...
| <a name="output_domain_name"></a> [domain\_name](#output\_domain\_name) | Domain name of the distribution |
| <a name="output_enabled"></a> [enabled](#output\_enabled) | Whether the module is enabled |
| <a name="output_hosted_zone_id"></a> [hosted\_zone\_id](#output\_hosted\_zone\_id) | Route53 zone ID for CloudFront alias records |
